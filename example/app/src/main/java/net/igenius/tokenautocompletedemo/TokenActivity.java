package net.igenius.tokenautocompletedemo;
...
import net.igenius.tokenautocomplete.FilteredArrayAdapter;
import net.igenius.tokenautocomplete.TokenCompleteTextView;
